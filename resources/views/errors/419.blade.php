...
<body class="antialiased">
    <div
        ...
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            ...
            <h2 class="text-lg font-semibold text-gray-500">What Happened?</h2>
            <p class="mt-2 text-gray-500">
                This form did not include a CSRF token. Laravel rejected the request to prevent Cross-Site Request
